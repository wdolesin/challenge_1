...
print(f"There are {number_loans} current loans: ")
...
avg_loan_cost = (total_loan_cost / number_loans)
print(f"The average loan cost is ${avg_loan_cost}")
...
if present_value >= cost:
    ...
    print("No, the loan is too expensive does not make sense at this time.")
...
print(f"The future value of the loan is: ${present_value:.2f}")
